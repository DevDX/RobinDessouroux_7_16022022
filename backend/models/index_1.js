...
const fs        = require("fs");
// OU   
//    Récupération des modèles de base de données des utilisateurs,
//    db.user = require("../models/user.models.js")(sequelize, Sequelize);
const path      = require("path");
const Sequelize = require("sequelize");

const sequelize = new Sequelize(process.env.DB_DATEBASE, process.env.DB_USER, process.env.DB_PASS, {    // semble ok
